...
let parseMap = {
    '新自建.5': 'https://op.洛阳it商城.com/player/ez.php?code=nkvod&if=1&url=',
    '新自建': 'https://op.洛阳it商城.com/player/ez.php?code=nkvod&if=1&url=',
    'Pp自建': 'https://op.洛阳it商城.com/player/ez.php?code=nkvod&if=1&url=',
    '自建三.5': 'https://op.洛阳it商城.com/player/ez.php?code=nkvod&if=1&url=',
    '新自建.0': 'https://op.洛阳it商城.com/player/ez.php?code=nkvod&if=1&url=',
    '自建三': 'https://op.洛阳it商城.com/player/ez.php?code=nkvod&if=1&url=',
    'Af自建': 'https://op.洛阳it商城.com/player/ez.php?code=nkvod&if=1&url=',
    '自建四': 'https://op.洛阳it商城.com/player/ez.php?code=nkvod&if=1&url=',
    '西瓜视频': 'https://op.洛阳it商城.com/player/xigua.php?code=nkvod&if=1&url=',
    '自建一': 'https://ag.洛阳it商城.com/nk.php?url=',
    '自建二': 'https://ag.洛阳it商城.com/nk.php?url=',
    '腾讯视频': 'https://op.洛阳it商城.com/player/gg.php?code=nkvod&if=1&url=',
    '奇艺视频': 'https://op.洛阳it商城.com/player/gg.php?code=nkvod&if=1&url=',
    '优酷视频': 'https://op.洛阳it商城.com/player/gg.php?code=nkvod&if=1&url=',
    '芒果视频': 'https://op.洛阳it商城.com/player/gg.php?code=nkvod&if=1&url=',
    'B站': 'https://op.洛阳it商城.com/player/gg.php?code=nkvod&if=1&url=',
    '量子资源': 'https://op.洛阳it商城.com/player/en.php?code=nkvod&if=1&url=',
    '非凡资源': 'https://op.洛阳it商城.com/player/en.php?code=nkvod&if=1&url=',
    '失效': 'https://op.洛阳it商城.com/player/ez.php?code=nkvod&if=1&url=',
